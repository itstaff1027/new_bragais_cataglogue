...
const CreateFilterProduct = ({ FilterProduct, products, filters }) => {
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            <h1 className="text-xl font-semibold mb-6">Create Filter Product</h1>
...
export default CreateFilterProduct;
