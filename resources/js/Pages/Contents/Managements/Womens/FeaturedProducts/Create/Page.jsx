...
const CreateFeaturedProduct = ({ FeaturedProduct, products }) => {
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            <h1 className="text-xl font-semibold mb-6">Create Featured Product</h1>
                            <form onSubmit={handleSubmit}>
                                {/* Name Input Field */}
                                <div className="mb-6">
                                    <InputLabel for="product_id" value="Featured Product Name" />
                                    <select
                                        id="product_id"
                                        name="product_id"
