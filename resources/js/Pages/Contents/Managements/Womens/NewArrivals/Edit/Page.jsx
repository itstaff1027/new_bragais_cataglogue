...
const EditNewArrival = ({ NewArrival, products }) => {
    const { data, setData, put, errors } = useForm({
        product_id: NewArrival.product_id || 0,
        category: 'womens',
        header: NewArrival.header || '',
        sub_header: NewArrival.sub_header || '',
        description_1: NewArrival.description_1 || '',
        description_2: NewArrival.description_2 || '',
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(`/new_arrival_product_womens/${NewArrival.id}`);
    };
                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            ...
                            <form onSubmit={handleSubmit}>
                                {/* Name Input Field */}
                                <div className="mb-6">
                                    <InputLabel for="product_id" value={`Featured Product Current Name: ${NewArrival.products.product_name}`} />
                                    <select
                                        id="product_id"
                                        name="product_id"
